...
```
cd existing_repo
git remote add origin https://jihulab.com/raspberrypi/KGCT_LCD_Panel_Driver.git
git branch -M main
...
- [ ] [Set up project integrations](https://jihulab.com/raspberrypi/KGCT_LCD_Panel_Driver/-/settings/integrations)
